...
**Что проверяли:**
- Метод: Живое интервью (1 из запланированных 3–5), полная транскрибация сохранена в `Interview_DataAnalysts_23_26_Transcript_Vakhrusheva_09.07.2026.md`
- Респондент: Вахрушева Татьяна Ивановна, аналитик данных, продукт «чат-бот для физлиц»
- Дата: 09.07.2026

**Что узнали:**
1. Основная боль — разработка новых отчётов/дашбордов (Power BI): минимум сутки (8ч) на простой дашборд, максимум неделя (~56ч), в сложных случаях (SQL с нуля + макет с нуля + сбор требований с нуля) — до месяца. Частота новых дашбордов: раз в месяц-два; за последние 3 месяца задач по Power BI было 3.
2. Самое трудоёмкое — не написание SQL-запроса («это вообще ерунда, по сути, это самое лёгкое»), а согласование требований с заказчиком — множество итераций.
3. Изменение логики уже существующего отчёта — отдельная, более редкая и мелкая боль: ~раз в месяц, до 8 часов/месяц.
4. AdHoc-запросы (не отчёты) — ежедневная задача, но короткая: ~20 мин/день суммарно, до 10 мин на один запрос. Для них уже разрабатывается внутренний AI-агент (команда Артёма Портнова), но пока не выкачен на смежные роли (сценаристов).
5. Для Power BI/дашбордов AI-поддержки сейчас нет вообще — по словам респондента, это был бы самый ценный кейс из всех.
6. Второстепенный, менее приоритетный сигнал — отсутствие документации по SQL-практикам команды для онбординга (+5 новых участников за полгода, −3 ушло); респондент сама оценивает это как «не активно требуется».
7. Доля спринта в целом — всё ещё не проверяли явно (нет прямого ответа на "% спринта"), но количественные данные по времени/частоте теперь есть по каждой подзадаче.

**Цитаты / данные:**
> «Наверное, разработка отчётностей и дэшбордов [самое трудоёмкое]... больше всего хотелось бы чего-то именно такого с исследованием» — Вахрушева Т.И.
> «Минимально, я бы сказала, сутки, чтобы сделать нормальный дэшборд. Максимально, я бы сказала, неделю... иногда это прям занимает до месяца» — Вахрушева Т.И.
> «Самое трудоёмкое — это... множество итераций от заказчика. А сам запрос, сам скрипт — это нет, не самое трудоёмкое» — Вахрушева Т.И.
> «То есть, грубо говоря, 8 часов в месяц. — Максимум, да.» [про изменение логики существующего отчёта] — Вахрушева Т.И.
> «Круто было бы, чтобы он умел с Power BI работать... Это было бы вообще замечательно. Но такого, насколько я знаю, правда нет. Пока.» — Вахрушева Т.И.
> «За последние три месяца я бы сказала три раза» [частота задач по Power BI] — Вахрушева Т.И.

**Решение:**
- [ ] Зелёный — продолжаем
- [x] Промежуточное — 1 интервью (детально расшифровано) подтверждает боль и её структуру; гипотезу можно сузить до Power BI/дашборд-разработки как наименее закрытого AI сегмента (AdHoc уже закрывается внутренним агентом); нужно 2–4 интервью с другими аналитиками для подтверждения паттерна
- [ ] Красный — стоп

**Что делаем дальше:**
- Следующий шаг: провести 2–4 интервью с другими аналитиками этой же команды (упомянута Маша Плеханова — по словам респондента, у неё много описательной/аналитической работы, хороший следующий контакт)
- Уточнить у остальных: разделяют ли они оценку "Power BI/дашборды — самая незакрытая боль", или это специфика конкретного респондента
...
- Источник: `Interview_DataAnalysts_23_26_Transcript_Vakhrusheva_09.07.2026.md`
